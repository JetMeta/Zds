/* #CC
       Zey_S : //z 17-08-06 02:09:40 L.147'78620 T4232767701.K.F3128813461-+----+----+----+----+
		//k
       Zey_E : //z 17-08-06 02:09:40 L.147'78620 T4232767701.K---+----+----+----+----+----+----+
       Zcl_S : //z 17-08-06 02:09:40 L.147'78620 T4232767701.K---+----+----+----+----+----+----+
       Zcl_E : //z 17-08-06 02:09:40 L.147'78620 T4232767701.K---+----+----+----+----+----+----+
      KmtIdx : //z 17-08-06 02:17:16 L.147'78164 T4233881655.K ~1   --+----+----+----+----+----+
     Zndex_S : //z 17-08-06 02:09:40 L.147'78620 T4232767701.K---+----+----+----+----+----+----+
      L1073,   1:todo: use __popcnt16, __popcnt, __popcnt64 for msvc builds
      L1122,   2:Todo: We need to deal with the case whereby sizeof(word_type) < sizeof(unsigned long)
      L1751,   3:Todo: We need to deal with the case whereby sizeof(word_type) < sizeof(unsigned long)
     Zndex_E : //z 17-08-06 02:17:41 L.147'78139 T4233881749.K ~3   --+----+----+----+----+----+
\* #HE //z 2017-08-06 02:09:40 L.147'78620 BG57IV3 T4232767701.K*******************************/
...
inline uint32_t GetLastBit(eastl_uint128_t x)
{
    if(x)
    {
        ...
        if(x & UINT64_C(0x00000000FFFFFFFE))
        {
            n +=  1;
        }
...
//k 2017-08-06 02:17 zn#1 没有计数器，而是每次调用都会重新计算，耗费比较多时间
template <size_t NW, typename WordType>
