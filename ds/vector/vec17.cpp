...
#region 07-11 R#.0    @Ver.Info
     ...
     Version : //z 17-07-14 15:15:13 L.170'31487 T4252230676.K ~409     R+.13   L+.534  --+----+
     ...
     Zndex_S : //z 17-07-11 10:33:47 L.173'48373 T1888754067.K ~0   --+----+----+----+----+----+
      L109,  1: 07-11 R#.2    @第2017.07月总结
      L116,  2: 07-11 zsum vector 实例
      L132,  3: 07-11 R#.1    @vector assign
      L195,  4: 07-11 R#.3    @vector 
      L214,  5: 07-11 R#.4    @捕获异常
      L228,  6: 07-11 R#.5    @push_back，自动增长内存
      L243,  7: 07-11 R#.6    @预保留10个字符
      L269,  8: 07-11 R#.7    @设置其中有多少元素
      L288,  9: 07-11 R#.8    @vector 输出
      L313, 10: 07-11 R#.9    @测试用例
      L390, 11: 07-11 R#.10   @class X
      L431, 12: 07-11 R#.11   @使用数组初始化 vector 
      L445, 13: 07-11 R#.12   @iterator
      L496, 14: 07-11 R#.13   @构造函数
     Zndex_E : //z 17-07-14 15:15:13 L.170'31487 T4252230676.K ~396 --+----+----+----+----+----+
